        ...
        >
            ...
            >
                <tr style={{ height: '50vh' }} className='m-0 p-0'>
                    <td><img alt='alt' src={img13} style={{ width: '50vw' }} /></td>
                    <td className=""
                        style={{ padding: '0 9%' }}
                    >
                        <span><img alt='alt' style={{ width: '17%', height: '10%' }} src={logo4} />
                            Regular Fit</span>
            ...
            <table className="mx-auto">
                ...
                <tr className="page2row2 bold-gold" style={{ height: '50vh' }}>
                    <td><img alt='alt' style={{ width: '25vw' }} src={img5} />
                        <p className='text-center bg-white py-2 h5 mb-0'>V neck</p></td>
                    <td><img alt='alt' src={img6} style={{ width: '25vw' }} />
                        <p className='text-center bg-white py-2 h5 mb-0'>Leaf Print</p>
                </td>
                <td><img alt='alt' src={img7} style={{ width: '25vw' }} />
