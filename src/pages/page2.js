        ...
        <div>
            <table className="pagetabl"
                ...
                <tr style={{ height: '50vh' }} className='m-0 p-0'>
                    <td><img src={img3} style={{ width: '50vw' }} /></td>
                    <td className=""
                        style={{ padding: '0 9%' }}
                    >
                        <span><img style={{ width: '17%', height: '10%' }} src={logo2} /> 100% Cotton</span>
                ...
                <td className=""
                        style={{ padding: '0 9%' }}
                    >
                        <span><img style={{ width: '17%', height: '10%' }} src={logo3} /> Woven Fabric</span>
                    ...
                    <td><img src={img4} style={{ width: '50vw', height: '50vh' }} /></td>
                </tr>
            </table >
        </div>
    );
